...
from datasets.dataset import CPC_multi_env_test
...
def main(args):
    ...
    dataset_train = CPC_multi_env_test(data_folder_path=args.train_path, 
                                       cache=args.cache_data,
                                       past_steps=cfg["contrast_sequence_length"],
                                       future_steps=args.time_step,
                                       train=False,
                                       temp_dim=cfg["Temporal_dim"])
    dataset_val = CPC_multi_env_test(data_folder_path=args.val_path,
                                     cache=args.cache_data,
                                     past_steps=cfg["contrast_sequence_length"],
                                     future_steps=args.time_step,
                                     train=False,
