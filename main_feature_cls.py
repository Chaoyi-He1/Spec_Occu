...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--resume', type=str, default='weights/feature_cls/model_299.pth', help="initial weights path")  # weights/model_940.pth
...
def main(args):
    ...
    model = build_feature_extractor_cls(cfg=cfg, pos_type=args.positional_embedding, in_type=cfg["in_type"])
    model.to(device)
    if args.rank in [-1, 0]:
