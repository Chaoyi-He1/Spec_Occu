...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--resume', type=str, default='weights/fine_tune/model_485.pth', help="initial weights path")  # weights/model_940.pth
...
def main(args):
    ...
    if args.resume.endswith(".pth"):
        ...
        try:
            ...
            # Check if ckpt has T2F_model key
            if "T2F_model" in ckpt.keys():
